...
aislop analyses 10 language targets: TypeScript, JavaScript, Expo/React Native, Python, Go, Rust, Ruby, PHP, C#, and C/C++. If your repository is primarily written in an unsupported language such as Swift or Kotlin, scoring a handful of incidental files would misrepresent the codebase.
